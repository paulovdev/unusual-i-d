...
const StudioAwards = () => {
  ...
  return (
    <section
      id="about"
      className="relative p-5 py-15 bg-bg-s flex flex-col items-start justify-between"
      ref={ref}
    >
        ...
        <div className="flex flex-col">
          {awards.map((item, i) => (
            <motion.div key={i} className="border-b border-p/5">
                ...
                <div className="flex items-center gap-10 max-lg:flex-col max-lg:items-start">
                  <div className="h-fit overflow-hidden">
                    <motion.h3
                      ...
                      custom={0.5 + 0.15 * i}
                      className="font-neue text-[42px] text-start text-p font-bold tracking-[-0.05em] leading-none uppercase"
                    >
                      {item.title}
                    </motion.h3>
                  </div>
              ...
              >
                <div className="pt-5 pb-15 pl-5 max-w-[900px] max-lg:pl-0">
                  <div className="grid grid-cols-1 gap-10 mb-15">
                    <div>
                  ...
                  <p className="max-w-125 paragraph-n text-p max-lg:max-w-full">
                    {item.description}
                  </p>
                </div>
              </motion.div>
